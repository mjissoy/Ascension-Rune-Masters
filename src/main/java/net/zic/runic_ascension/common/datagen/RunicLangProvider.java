...
public class RunicLangProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("runic_ascension.runic.codex.tab.runes", "Runes");
        add("runic_ascension.runic.codex.tab.sequences", "Seq.");
        add("runic_ascension.runic.codex.tab.inscriptions", "Marks");
        add("runic_ascension.runic.codex.tab.scraps", "Scraps");
        add("runic_ascension.runic.codex.page.runes.left", "Rune Index");
        add("runic_ascension.runic.codex.page.runes.right.empty", "Rune Notes");
        add("runic_ascension.runic.codex.page.sequences.left", "Sequence Index");
        add("runic_ascension.runic.codex.page.sequences.right.empty", "Sequence Notes");
        add("runic_ascension.runic.codex.page.inscriptions.left", "Inscription Index");
        add("runic_ascension.runic.codex.page.inscriptions.right.empty", "Inscription Notes");
        add("runic_ascension.runic.codex.page.scraps.left", "Scrap Index");
        add("runic_ascension.runic.codex.page.scraps.right.empty", "Scrap Notes");
        add("runic_ascension.runic.codex.rune_select_hint", "Select a rune from the opposite page to study its type, depth, and known sequences.");
        add("runic_ascension.runic.codex.sequence_select_hint", "Select a sequence from the opposite page to inspect its shape. Higher Runic realms reveal deeper readings.");
        add("runic_ascension.runic.codex.inscription_select_hint", "Select an inscription pattern to inspect current effects and the next evolution requirement.");
        add("runic_ascension.runic.codex.scrap_select_hint", "Select a recorded scrap to reread its lesson.");
        add("runic_ascension.runic.codex.rune_sequences", "Known Sequences Using This Rune");
        add("runic_ascension.runic.codex.rune_sequences.none", "No discovered sequence in this Codex currently uses that rune.");
        add("runic_ascension.runic.codex.more_entries", "+%s more entries.");
        add("runic_ascension.runic.codex.realm_veil", "Further details remain veiled until Runic Realm %s.");
        add("runic_ascension.runic.codex.yes", "yes");
        add("runic_ascension.runic.codex.no", "no");
        add("runic_ascension.runic.codex.sequence_order", "Order sensitive: %s");
        add("runic_ascension.runic.codex.sequence_known_note", "Repeated use steadies memory, making later mastery readings clearer.");
        add("runic_ascension.runic.codex.no_inscriptions", "No inscription patterns are recorded.");
        add("runic_ascension.runic.codex.no_scraps", "No scraps recorded.");
        add("runic_ascension.runic.codex.inscription_list.none", "%s | not inscribed");
        add("runic_ascension.runic.codex.inscription_list.tier", "%s | %s/%s");
        add("runic_ascension.runic.codex.inscription_none", "not inscribed");
        add("runic_ascension.runic.codex.inscription_tier", "%s (%s/%s)");
        add("runic_ascension.runic.codex.inscription_current", "Current: %s");
        add("runic_ascension.runic.codex.inscription_effect", "Current Effect");
        add("runic_ascension.runic.codex.inscription_next", "Next: %s");
        add("runic_ascension.runic.codex.inscription_requirements", "Requires Runic Realm %s and runes: %s. Missing: %s.");
        add("runic_ascension.runic.codex.inscription_maxed", "This inscription has reached its current limit.");
