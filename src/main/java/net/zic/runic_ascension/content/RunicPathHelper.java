...
public final class RunicPathHelper {
    ...
    private static final String RUNIC_DATA_TAG = "runic_ascension";
    ...
    public static boolean hasEnteredRunicPath(IEntityData entityData) {
        return entityData != null && entityData.hasPath(RunicPaths.RUNIC.getId());
    }
    ...
    public static int getRunicMajorRealm(IEntityData entityData) {
        ...
        IPathData pathData = entityData.getPathData(RunicPaths.RUNIC.getId());
